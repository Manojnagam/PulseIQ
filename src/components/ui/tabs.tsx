...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-muted/60 p-1 text-muted-foreground dark:bg-zinc-900 dark:border dark:border-zinc-800",
      className
    )}
    {...props}
  />
